...
**email_1 (first email, sent within minutes of the enquiry):** Open with personal ownership — you just received their enquiry and you are responding directly. In one short paragraph, SHORTLY acknowledge the specific role they asked about and the reason they gave for reaching out. Go straight to the CTA: close with a soft assumptive question asking when would be a good time to connect and go over the details, then reference the link you have put below for them to pick any time that works. two short paragraphs maximum.
