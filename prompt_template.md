...
Ask exactly two short, genuine discovery questions drawn from what they submitted. Each question must be under 12 words. Short and punchy — no elaboration, no sub-clauses, no padding. Choose questions that fit the context — for example: Is this a first build offshore, or have you done this before? New role, or backfilling? Are you still shaping the profile, or do you know what you need? What is prompting this now? Each question is its own paragraph.
